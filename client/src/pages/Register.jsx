    ...
    <>
      ...
      <div className="register-page">
        ...
        <style>{`
          ...
          .register-card {
            width: 100%;
            max-width: 560px;  /* ✅ أكبر شوي عشان ما يكون ضيق */
            background:
              radial-gradient(circle at top, rgba(246, 162, 59, 0.10), transparent 55%),
          ...
          @media (max-width: 640px) {
            ...
            .register-brand { font-size: 1.6rem; }
          }
        `}</style>
      </div>
    </>
